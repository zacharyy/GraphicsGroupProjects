...
# Mac
	...
	CC=clang++
	LIBS=-lSDL2 -framework OpenGL -framework Cocoa -lGLEW -stdlib=libc++ -lassimp `Magick++-config --cppflags --cxxflags --ldflags --libs`
endif
...
# .o Compilation
O_FILES=main.o camera.o engine.o graphics.o mesh.o object.o shader.o window.o
...
all: $(O_FILES)
	$(CC) $(CXXFLAGS) -o PA6 $(O_FILES) $(LIBS) #$(PATHI) $(PATHL)
...
mesh.o: ../src/mesh.cpp
	$(CC) $(CXXFLAGS) -c ../src/mesh.cpp -o mesh.o $(INDLUDES)
...
clean:
	-@if rm *.o PA6 2>/dev/null || true; then echo "Main Removed"; else echo "No Main"; fi
